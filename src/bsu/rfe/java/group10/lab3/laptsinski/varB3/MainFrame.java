package bsu.rfe.java.group10.lab3.laptsinski.varB3;//TIP To <b>Run</b> code, press <shortcut actionId="Run"/> or
...
// Добавить его в главное меню
        ...
        aboutItem.addActionListener(e -> {
            JOptionPane.showMessageDialog(null, "Автор: Лаптинский, Группа: 10",
        ...
        public void actionPerformed(ActionEvent event) {
            if (fileChooser==null) {
// Если экземпляр диалогового окна "Открыт файл" еще не создан,
// то создать его
